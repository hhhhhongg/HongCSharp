...
public class Dealer : Player
{
    ...
    public void KeepDrawingCards(Deck deck)
    {
        while (Hand.GetTotalValue() < 17)
        {
            ...
            Console.WriteLine($"딜러는 '{drawnCard}'을(를) 뽑았습니다.");
            Console.WriteLine($"딜러가 뽑은 카드의 총합은 {Hand.GetTotalValue()}점입니다.");
        }
    }
}
    ...
    public void PlayGame()
    {
        ...
        while (player.Hand.GetTotalValue() < 21)
        {
            ...
            if (input.ToLower() == "y")
            {
                ...
                Console.WriteLine($"'{drawnCard}'을(를) 뽑았습니다.");
                Console.WriteLine($"현재 플레이어가 뽑은 카드의 총합은 {player.Hand.GetTotalValue()}입니다.");
            }
            else
            {
                Console.WriteLine("플레이어의 턴 종료");
                break;
            }
        }
        ...
        Console.WriteLine($"딜러의 총합은 {dealer.Hand.GetTotalValue()}입니다.");
